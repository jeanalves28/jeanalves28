	...
	theme: {
		extend: {
			...
			animation: {
				...
				'fading-up-container-1': 'fading-open .5s .2s backwards ease-out',
				'fading-up-container-2': 'fading-open .5s .4s backwards ease-out',
				...
				'grow-message': 'grow-message .2s .5s both ease-out',
