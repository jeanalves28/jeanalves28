	...
	return (
		...
		>
			<Link
				href={deployPath}
				target="_blank"
				className={`${bgContainer(theme, path)} group w-full pc:hover:w-100 min-h-70 pc:max-h-70 pc:hover:max-h-200 pc:absolute pc:top-1/2 pc:left-1/2 pc:-translate-x-1/2 pc:-translate-y-1/2 pc:overflow-hidden transition-card ease-out duration-500 gap-y-6 pc:gap-y-10 flex flex-col pb-10 pc:pb-5 items-center rounded-lg pc:shadow-md pc:hover:shadow-2xl max-pc:shadow-lg`}
			>
				<Image
					src={src}
					alt={title}
