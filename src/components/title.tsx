...
export default function Title({
	...
	const classHeading1 = `${toggleTheme} font-bold select-none font-title text-4xl`;

	const classHeading2 = `${toggleTheme} font-bold select-none font-title text-2xl border-b-4`;
