...
export default function Card() {
	...
	return (
		<section className="relative min-h-dvh pt-30 flex flex-col items-center justify-end">
			...
			<Header />
			<div
				className={`${bgContainer(theme, path)} hover:-translate-y-0.5 duration-500 transition-transform w-93/100 tablet:w-120 rounded-lg relative z-1`}
			...
			>
				<div className="relative gap-y-8 border-b border-r border-inherit rounded-lg pb-4 flex flex-col items-center">
					...
					<Link
						...
						target="_blank"
					>
						<Button className="pc:hover:bg-sky-400 pc:hover:shadow-ring-blur pc:hover:shadow-sky-400/30 pc:hover:text-slate-800 pc:bg-transparent pc:border-sky-400 pc:text-sky-400 border bg-sky-400 pc:duration-150 pc:transition-btn-outline pc:ease-in-out text-black border-sky-400 rounded-l-full! rounded-r-full! h-full w-full cursor-pointer">
							Site
						</Button>
					</Link>
				</div>
