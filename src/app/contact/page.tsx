...
export default function Page() {
	const {
		...
		handlerInput,
		handlerSubmitEmail, handlerTextarea,
	...
	return (
		<>
			...
			>
				<form
					className={`z-1 flex w-180 flex-col transition-bg duration-200 ${bgContainer(
						theme,
						usePathname(),
				...
				>
					...
					<Textarea
						...
						classTextarea="input-blue h-full resize-none"
						cols={20}
						rows={20}
					...
					<div className="flex h-24 flex-col items-center justify-between self-stretch">
						<Button
							classButton="w-1/2 h-10 btn-blue"
							loading={isLoading}
